...
function pricecal(time, ticket, activity, food, num, table){   
   ...
   let price = 0;
    if(ticket==="Local-Child"){
        if(time === "12 hours"){
            foodTotal = food * 500;
            price = Lchild + activityprice + Lhalf;
            console.log(price);
            total += price * num + foodTotal;
            if(table == true){
            ...
            foodTotal = food * 500;
            price = Lchild + activityprice + Lfull;
            total += price * num + foodTotal;
            if(table == true){
                carttable(total, ticket, time, price, activity, num);
            }
            ...
            foodTotal = food * 500;
            price = Lchild + activityprice + (Lfull * 2);
            total += price * num + foodTotal;
            if(table == true){
                carttable(total, ticket, time, price, activity, num);
            }
        ...
        if(time === "12 hours"){
            foodTotal = food * 500;
            price = Ladult + activityprice + Lhalf;
            total += price * num + foodTotal;
            if(table == true){
                carttable(total, ticket, time, price, activity, num);
            }
            ...
            foodTotal = food * 500;
            price = Ladult + activityprice + Lfull;
            total += price * num + foodTotal;
            if(table == true){
                carttable(total, ticket, time, price, activity, num);
            }
            ...
            price = Ladult + activityprice + (Lfull * 2);
            foodTotal = food * 500;
            total += price * num + foodTotal;
            if(table == true){
                carttable(total, ticket, time, price, activity, num);
        ...
        if(time === "12 hours"){
            foodTotal = food * 500;
            price = Fchild + activityprice + Fhalf;
            total += price * num + foodTotal;
            if(table == true){
                carttable(total, ticket, time, price, activity, num);
            }
            ...
            foodTotal = food * 500;
            price = Fchild + activityprice + Ffull;
            total += price * num + foodTotal;
            if(table == true){
                carttable(total, ticket, time, price, activity, num);
            }
            ...
            price = Fchild + activityprice + (Lfull * 2);
            foodTotal = food * 500;
            total += price * num + foodTotal;
            if(table == true){
                carttable(total, ticket, time, price, activity, num);
        ...
        if(time === "12 hours"){
            foodTotal = food * 500;
            price = Fadult + activityprice + Fhalf;
            total += price * num + foodTotal;
            if(table == true){
                carttable(total, ticket, time, price, activity, num);
            }
            ...
            foodTotal = food * 500;
            price = Fadult + activityprice + Ffull;
            total += price * num + foodTotal;
            if(table == true){
                carttable(total, ticket, time, price, activity, num);
            }
            ...
            price = Fadult + activityprice + (Ffull * 2);
            foodTotal = food * 500;
            total += price * num + foodTotal;
            if(table == true){
                carttable(total, ticket, time, price, activity, num);
